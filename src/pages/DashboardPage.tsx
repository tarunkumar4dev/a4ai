...
import { Link, useNavigate, useSearchParams } from "react-router-dom"; // useSearchParams import karo
import {
  motion,
  AnimatePresence,
  useMotionTemplate,
...
import ScratchCard from "@/components/ScratchCard"; // Ye import karo
...
export default function DashboardPage() {
  ...
  const [searchParams] = useSearchParams(); // Search params access karo
  ...
  // ✅ Scratch Card State - Ye add karo
  const [showScratchCard, setShowScratchCard] = useState(false);

  // ✅ Check if new user - Ye useEffect add karo
  useEffect(() => {
  ...
  // ✅ Handle scratch card close - Ye function add karo
  ...
  return (
    <div
      ...
      onMouseMove={onMove}
    >
      {/* ✅ Scratch Card Popup - Ye add karo */}
      <ScratchCard 
