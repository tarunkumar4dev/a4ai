...
// ──────────────────────────────────────────────────────────
// Admin leaderboard — full ranked list with all participant info.
// Teacher sees this. Privacy-respecting public version is at /q/{slug}
// ──────────────────────────────────────────────────────────
...
const Icons = {
  ...
  Trophy: ({ size = 14 }: { size?: number }) => <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor"><path d="M6 9H4.5a2.5 2.5 0 0 1 0-5H6V2h12v2h1.5a2.5 2.5 0 0 1 0 5H18v0a6 6 0 0 1-12 0v0z"/></svg>,
    ...
    <div className="sf-pro min-h-[100dvh] w-full text-[15px] text-[#1d1d1f] relative bg-[#F5F5F7]">
      ...
      <main className="relative z-10 max-w-[840px] mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <header className="flex items-center gap-3 mb-8 anim-in">
          <button onClick={() => navigate(-1)} className="ap-btn-secondary w-9 h-9 rounded-full flex items-center justify-center">
            <Icons.ArrowLeft />
          </button>
